...
from src.crud.crud_incident import (
    CrudIncident
)
...
class IncidentService:
    """
    The "brain" for all business
    logic related to incidents.
    ...
    async def _check_permission(
        ...
        """
        A helper method to standardize
        permission checks.
        """
        is_commander \
            = incident.profile \
    ...
    async def get_incidents(
        ...
        *,
        ...
        """
        Searches and retrieves a list of
        incidents based on filter criteria.
        This method directly utilizes the
        powerful search method from the CRUD layer.
        """
    ...
    async def update_shallow_rca(
        ...
        *,
        ...
        """
        Updates the shallow root cause
        analysis section of an incident.
        """
        incident = await self.get_incident_by_id(
            incident_id=incident_id
        )
